...
export const TRANSLATIONS: Record<'en' | 'sq', TranslationSet> = {
  en: {
    ...
    menuSubtitle: 'Authentic Neapolitan Pizzas, Pressed Gourmet Sandwiches, and Icy Refreshments.',
  ...
  sq: {
    ...
    menuSubtitle: 'Pica Napolitane Autentike, Sanduiçë të Shtypur Gustatorë dhe Pije të Ftohta.',
    popular: 'E Preferuar',
    price: 'Çmimi',
    sizeMedium: 'E Mesme',
