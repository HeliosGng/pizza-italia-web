...
export const TRANSLATIONS: Record<'en' | 'sq', TranslationSet> = {
  en: {
    ...
    menuSubtitle: 'Authentic Neapolitan Pizzas,Pizza Dough Sandwiches , and Icy Refreshments.',
    ...
    pizzaSection: 'Authentic Pizzas 🍕',
    sandwichSection: 'Pizza Dough Sandwich 🥪',
  ...
  sq: {
    ...
    menuSubtitle: 'Pica Napolitane Autentike, Sanduiç me Brumë Pice  dhe Pije të Ftohta.',
    popular: 'E Preferuar',
    price: 'Çmimi',
    sizeMedium: 'E Mesme',
    ...
    quickNotice: 'Hapur • Shërbim me Motorrist - Falas 10:00 - 24:00',
